document.addEventListener('DOMContentLoaded', () => {
    ...
    const dashboard = document.getElementById('dashboard'); // Only one declaration
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeDashboard() {
        const socket = io();
        // ... (resto de initializeDashboard como estaba antes)
        ...
        function triggerDetection(socket) {
            ...
            displayNotification('Ruta detectada: C:\\Users\\matbe\\Desktop\\ProyectoIntermodular-Grupo2\\componentes\\web-interface', 'info');
    ...
    function startDetectionTimer() {
        ...
        detectionTimerDiv.textContent = ''; // Clear previous text
