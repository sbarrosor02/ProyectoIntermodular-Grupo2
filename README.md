...
3.  **Integración de Sensores:** 
    ...
    *   Lleva sus cables de señal a los **Pines 2 y 3** respectivamente.
4.  **Instalación del Buzzer:** Conecta el terminal positivo al **Pin 4** y el negativo a la línea de GND común.
...
1.  **Carga de Bibliotecas:** En el IDE de Arduino, pulsa `Ctrl+Shift+I` y busca "MFRC522" y "NTPClient".
    *   *Opción Terminal (arduino-cli):* 
        ...
        ```
2.  **Configuración Secreta:** Abre la pestaña `arduino_secrets.h` y rellena tus datos WiFi.
3.  **Compilación y Carga:** Pulsa `Subir`.
    *   *Opción Terminal:* 
        ...
        ```
        *(Nota: Reemplaza COM3 por el puerto real de tu placa).*
